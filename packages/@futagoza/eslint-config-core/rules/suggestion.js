...
/**
 * Raw config for `@futagoza/eslint-config-core/rules/suggestion.js`
 */
export const config = {

    name: "@futagoza/eslint-config-core/suggestion",
...
/**
 * ESLint ready config for `@futagoza/eslint-config-core/rules/suggestion.js`
 */
