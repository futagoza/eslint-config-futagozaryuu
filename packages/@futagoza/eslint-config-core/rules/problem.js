...
/**
 * Raw config for `@futagoza/eslint-config-core/rules/problem.js`
 */
export const config = {

    name: "@futagoza/eslint-config-core/problem",
    ...
    rules: {
         ...
         * 
         * @see http://eslint.org/docs/rules/no-unassigned-vars
         */
         ...
         * 
         * @see http://eslint.org/docs/rules/no-useless-assignment
         */
...
/**
 * ESLint ready config for `@futagoza/eslint-config-core/rules/problem.js`
 */
